"""
Django settings for eventos_ms project.
...
SECRET_KEY = 'django-insecure-rk7o3*!&#-$jlc6ggp$d+9*&8h&jj4db)0q-kse4a4sc#6d%@6'
...
WSGI_APPLICATION = 'eventos_ms.wsgi.application'
